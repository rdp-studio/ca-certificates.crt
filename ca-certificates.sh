...
${DOWNLOADER} https://raw.githubusercontent.com/rdp-studio/ca-certificates.crt/download/ca-certificates.crt ||
    ${DOWNLOADER} https://cdn.jsdelivr.net/gh/rdp-studio/ca-certificates.crt@download/ca-certificates.crt ||
    ${DOWNLOADER} https://gh.rdp-studio.workers.dev/ca-certificates.crt/download/ca-certificates.crt
